...
public class Pokemon extends AbstractPokemon {
    ...
    /**
     * Lowercase file-name stem with no extension, e.g. "squirtle". Sprite sites often serve
     * .avif/.webp instead of the .gif the URL implies (browser format negotiation), so the
     * front end tries several extensions against this base name until one loads.
     */
